<template>
	<section class="ml-2 mr-3 pt-md-4 pt-2 mb-3">
		<div class="row m-md-0 m-2">
			<h5 class="col-12 ml-3 mb-md-0 pl-1 mb-2">
				Cadastro <button id="btn-back" class="btn btnBack" @click="goBack()"><i class="fa fa-arrow-right"></i> Retornar</button>
			</h5>
...
<script>
	...
	import { put } from './../../services/put.request.js'
	export default {
		components: {
			'vueInput': vueInput
		},
